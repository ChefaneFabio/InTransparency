...
interface MatchesPanelProps { embedded?: boolean }

export default function MatchesPanel({ embedded = false }: MatchesPanelProps = {}) {
  ...
  if (loading) {
    return (
      <div className={embedded ? '' : 'container max-w-4xl mx-auto py-8 px-4'}>
        {!embedded && <Skeleton className="h-24 w-full mb-6" />}
