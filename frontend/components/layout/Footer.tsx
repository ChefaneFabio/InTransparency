...
export function Footer() {
  ...
  const navigation = {
    product: [
      ...
      { name: tFooter('productLinks.discoverCompanies'), href: '/discover' },
    ],
    resources: [
      { name: tFooter('resourceLinks.faq'), href: '/faq' },
      { name: tFooter('resourceLinks.glossary'), href: '/glossary' },
      { name: tFooter('resourceLinks.facts'), href: '/facts' },
    ...
    compliance: [
      { name: tFooter('complianceLinks.euMatrix'), href: '/eu-compliance' },
      { name: tFooter('complianceLinks.algorithmRegistry'), href: '/algorithm-registry' },
