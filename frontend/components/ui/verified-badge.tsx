...
export function VerifiedBadge({
  ...
  if (variant === 'inline') {
    return (
      <Badge
        variant="secondary"
        className="bg-primary/5 text-green-700 border-primary/20 hover:bg-primary/10"
      >
  ...
  const badgeContent = (
    <div className="inline-flex items-center gap-2 px-3 py-2 bg-primary/5 border border-primary/20 rounded-lg cursor-pointer hover:border-primary/30 transition-colors">
      <div className="flex items-center justify-center w-8 h-8 bg-primary/10 rounded-full">
        <CheckCircle className="h-5 w-5 text-primary" />
      </div>
      <div className="text-left">
        <div className="text-xs text-primary font-medium">VERIFIED BY</div>
