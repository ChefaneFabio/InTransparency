...
export function BidirectionalCommunication({ locale = 'it' }: BidirectionalCommunicationProps) {
  ...
  const content = {
    it: {
      ...
      flowStep2Desc: 'Il tuo portfolio verificato appare: "Alta compatibilità - progetto e-commerce verificato da Politecnico"',
    ...
    en: {
      ...
      flowStep2Desc: 'Your verified portfolio appears: "High match - e-commerce project verified by Politecnico"',
