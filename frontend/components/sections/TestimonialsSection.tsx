...
export function TestimonialsSection() {
  ...
  const sections = [
    { segment: 'students' as const, reverse: false },
    { segment: 'institutions' as const, reverse: true },
    { segment: 'companies' as const, reverse: false },
  ]
            ...
            return (
              ...
              >
                ...
                <div className={section.reverse ? 'lg:order-2' : 'lg:order-1'}>
                  <AppPreview segment={section.segment} />
                </div>
