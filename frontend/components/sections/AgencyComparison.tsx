...
export function AgencyComparison({ locale = 'it' }: AgencyComparisonProps) {
  ...
  const content = {
    it: {
      ...
      title: 'Risparmia il 99% vs Agenzie Interinali',
      subtitle: 'Le agenzie tradizionali costano €4.500-7.500 per assunzione. Con InTransparency contatti i primi 5 candidati al mese gratis, poi €89/mese per illimitati.',
      ...
      ourPrice: '€89',
      ourPer: 'al mese, contatti illimitati',
      ourNote: '5 contatti/mese gratis, poi abbonamento',
      ...
      ourFeatures: [
        { text: '5 contatti/mese gratis · poi €89/mese illimitati', negative: false },
        ...
        { text: 'Niente vincoli annuali, cancelli quando vuoi', negative: false },
      ...
      ourTotal: '€267',
      ourCalc: '3 mesi di abbonamento × €89',
      realSavings: '€22.200+',
    ...
    en: {
      ...
      title: 'Save 99% vs Staffing Agencies',
      subtitle: 'Traditional agencies charge €4,500-7,500 per hire. With InTransparency the first 5 contacts each month are free, then €89/mo for unlimited.',
      ...
      ourTitle: 'InTransparency',
      ourPrice: '€89',
      ourPer: '/mo, unlimited contacts',
      ourNote: '5 free contacts/month, then subscribe',
      ...
      ourFeatures: [
        { text: '5 free contacts/month · then €89/mo unlimited', negative: false },
        ...
        { text: 'No annual lock-in, cancel anytime', negative: false },
      ...
      ourTotal: '€267',
      ourCalc: '3 months subscription × €89',
      realSavings: '€22,200+',
