    ...
    <div className="max-w-5xl mx-auto pb-8">
      ...
      <Card className="mb-6">
        ...
        <CardContent className="space-y-4">
          <div>
            <p className="text-sm text-muted-foreground mb-1.5">URL</p>
          ...
          <div>
            ...
            <div className="flex items-start gap-2">
              <code className="flex-1 text-xs text-muted-foreground p-3 bg-muted/50 rounded-lg border break-all">
                {embedCode}
              </code>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <div className="flex items-center justify-center h-10 border-2 border-dashed rounded-md text-xs text-muted-foreground/60">
