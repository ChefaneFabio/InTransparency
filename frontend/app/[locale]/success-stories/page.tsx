              ...
              <div className="grid md:grid-cols-3 gap-6 mt-12 mb-12">
                <Card className="bg-white/60 backdrop-blur border-dashed border-2 border-gray-300">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <h3 className="font-semibold text-gray-500 mb-2">{t('cards.yourStory.title')}</h3>
                    <p className="text-sm text-gray-400">
                      {t('cards.yourStory.description')}
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/60 backdrop-blur border-dashed border-2 border-gray-300">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <h3 className="font-semibold text-gray-500 mb-2">{t('cards.realStudents.title')}</h3>
                    <p className="text-sm text-gray-400">
                      {t('cards.realStudents.description')}
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-white/60 backdrop-blur border-dashed border-2 border-gray-300">
                  <CardContent className="pt-8 pb-8 text-center">
                    ...
                    <h3 className="font-semibold text-gray-500 mb-2">{t('cards.comingSoon.title')}</h3>
                    <p className="text-sm text-gray-400">
                      {t('cards.comingSoon.description')}
                    </p>
                  </CardContent>
                </Card>
              </div>
