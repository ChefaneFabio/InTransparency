...
/**
 * /for-high-school-students — high-school student page.
 *
 * Slim scaffold (hero + metrics + comparison + CTA) with PCTO-grade
 * anchor messaging (90/150/210h tracked, portable to university,
 * GDPR-K for under-18s). Emerald accent matches the institutional
 * /for-high-schools family.
 */
...
export default function ForHighSchoolStudentsPage() {
  const t = useTranslations('forHighSchoolStudents')
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
        ...
        <EditorialHero
          ...
          cta={
            <div className="flex flex-col sm:flex-row gap-3">
              <Link
                href="/auth/register/student?type=high-school"
      ...
      <Footer />
      <StickyCTA show={showSticky} text={t('cta.button')} href="/auth/register/student?type=high-school" />
    </div>
  )
}
