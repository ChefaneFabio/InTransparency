...
export default function UniversityStudentsPage() {
  const t = useTranslations('studentsUniversity')
            ...
            <Card className="bg-primary/5 border-2 border-primary/20">
              <CardContent className="py-8">
                <div className="grid md:grid-cols-2 gap-8 items-center">
                  <div>
                    <Badge variant="secondary" className="mb-3">{t('uniLabel')}</Badge>
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li className="flex items-start">
                        ...
                        <span>{t('uniCheck1')}</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-primary mr-2 mt-0.5" />
                        <span>{t('uniCheck2')}</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="h-4 w-4 text-primary mr-2 mt-0.5" />
                        <span>{t('uniCheck3')}</span>
                      </li>
                    </ul>
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <Card className="text-center p-4">
                      ...
                      <div className="text-2xl font-bold">{t('portfolio')}</div>
                      <div className="text-xs text-muted-foreground">{t('portfolioSub')}</div>
                    </Card>
                    <Card className="text-center p-4">
                      <Globe className="h-7 w-7 text-primary mx-auto mb-2" />
                      <div className="text-2xl font-bold">{t('global')}</div>
                      <div className="text-xs text-muted-foreground">{t('globalSub')}</div>
                    </Card>
                    <Card className="text-center p-4">
                      <Shield className="h-7 w-7 text-primary mx-auto mb-2" />
                      <div className="text-2xl font-bold">100%</div>
                      <div className="text-xs text-muted-foreground">{t('certified')}</div>
                    </Card>
                    <Card className="text-center p-4">
