...
export default function ForStudentsPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-white pt-32 pb-16 lg:pt-36 lg:pb-20">
      ...
      <section className="bg-slate-50 pt-32 pb-16 lg:pt-36 lg:pb-20">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          <motion.div
            initial="hidden" whileInView="visible"
            viewport={{ once: true, margin: '-80px' }}
      ...
      {/* ─── CTA ─── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-32 pb-16 lg:pt-36 lg:pb-20">
