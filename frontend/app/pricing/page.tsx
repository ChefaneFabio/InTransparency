...
const institutePlans = [
  ...
  {
    name: 'Premium Embed & Branding',
    price: '€500',
    period: 'per year',
    description: 'Branded widgets for your website. Drive 40% more student sign-ups. Core platform stays free.',
    icon: Building2,
    popular: false,
    badge: '🎨 Boost Engagement',
    features: [
      '✅ Everything in Free, plus:',
      '🌐 Embeddable widget for your website/career portal',
      '📊 "InTransparency Matches" showing "3 students matched to BMW today"',
      ...
      '📑 Custom placement reports for MIUR/accreditation',
      '📊 Advanced analytics: Referral source tracking, conversion funnels',
      '⚡ Priority support: Dedicated onboarding and strategy sessions',
