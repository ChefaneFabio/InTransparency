...
const ContentSecurityPolicy = `
  default-src 'self';
  script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://*.vercel.app https://vitals.vercel-insights.com https://maps.googleapis.com https://*.gstatic.com https://*.hs-scripts.com https://*.hs-analytics.net https://*.hs-banner.com https://*.hsforms.net https://*.hsforms.com https://*.hsleadflows.net https://*.hscollectedforms.net https://*.hsappstatic.net https://*.hubspotusercontent.com https://*.hubspotusercontent-eu1.net https://*.hubspot.com ${isDev ? "http://localhost:* ws://localhost:*" : ''};
  ...
  connect-src 'self' https://vitals.vercel-insights.com https://*.vercel.app https://api-intransparency.onrender.com https://maps.googleapis.com https://*.gstatic.com https://*.r2.cloudflarestorage.com https://*.r2.dev https://*.hubspot.com https://*.hs-scripts.com https://*.hs-analytics.net https://*.hs-banner.com https://*.hsforms.com https://*.hsforms.net https://*.hsleadflows.net https://*.hscollectedforms.net https://*.hsappstatic.net https://*.hubspotusercontent.com https://*.hubspotusercontent-eu1.net https://api-eu1.hubapi.com https://forms-eu1.hubspot.com https://track-eu1.hubspot.com ${isDev ? 'http://localhost:* ws://localhost:* wss://localhost:*' : ''};
  frame-src 'none';
  object-src 'none';
  base-uri 'self';
  form-action 'self';
